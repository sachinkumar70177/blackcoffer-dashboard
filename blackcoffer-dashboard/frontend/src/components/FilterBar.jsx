  ...
  return (
    <div className="filters-panel">
      ...
      {FIELDS.map(({ key, label }) => {
        const opts = (options[key] || []).map((v) => ({
          value: v,
          label: String(v),
        }));
        const value = (filters[key] || []).map((v) => ({
          value: v,
          label: String(v),
        }));
        return (
      ...
      <div className="filter-group">
        ...
        <div style={{ display: "flex", gap: 8 }}>
          <input
            ...
            onChange={(e) =>
              onChange({ ...filters, intensity_min: e.target.value })
            }
            style={{
              width: "50%",
              background: "#0f1117",
          ...
          <input
            ...
            onChange={(e) =>
              onChange({ ...filters, intensity_max: e.target.value })
            }
            style={{
              width: "50%",
              background: "#0f1117",
      ...
      <div className="filter-group">
        ...
        <div style={{ display: "flex", gap: 8 }}>
          <input
            ...
            onChange={(e) =>
              onChange({ ...filters, likelihood_min: e.target.value })
            }
            style={{
              width: "50%",
              background: "#0f1117",
          ...
          <input
            ...
            onChange={(e) =>
              onChange({ ...filters, likelihood_max: e.target.value })
            }
            style={{
              width: "50%",
              background: "#0f1117",
      ...
      <div className="filter-group">
        ...
        <div style={{ display: "flex", gap: 8 }}>
          <input
            ...
            onChange={(e) =>
              onChange({ ...filters, relevance_min: e.target.value })
            }
            style={{
              width: "50%",
              background: "#0f1117",
          ...
          <input
            ...
            onChange={(e) =>
              onChange({ ...filters, relevance_max: e.target.value })
            }
            style={{
              width: "50%",
              background: "#0f1117",
